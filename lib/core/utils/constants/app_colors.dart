...
class AppColors {
  ...
  static const Color scaffoldColor = Color(0xfff4f5f7);
  ...
  static const List<Color> secondaryGradientColors = [Colors.grey, Colors.grey];
  static const List<Color> suitsSelectorColors = [
    Color(0xff4E6542),
    Color(0xff323232),
    Color(0xffC11D1D),
    Color(0xff979696),
